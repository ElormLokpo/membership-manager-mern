  ...
  "w-full rounded-lg hover:cursor-pointer disabled:cursor-not-allowed text-sm flex items-center justify-center disabled:opacity-70",
  {
    variants: {
      variant: {
        ...
        ["dash-def"]:
          " hover:bg-stone-700 bg-black dark:bg-white dark:text-black px-5 py-2 rounded-full text-white",
        ["dash-sec"]:
          "font-semibold hover:bg-stone-200 dark:hover:bg-stone-700 border border-black dark:border-white px-5 py-2 rounded-full ",
        bare: "hover:cursor-pointer hover:underline",
      },
    },
    defaultVariants: {
      variant: "auth",
